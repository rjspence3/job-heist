...
Commit, push, and open a PR for the current changes in jobheist.
...
npm run build   # Must complete — catches type errors
```
...
Add new source files explicitly if needed. Do not add `.next/`,
`node_modules/`, or `.playwright-mcp/`.
...
- [ ] [any manual verification at http://jobheist.test]
