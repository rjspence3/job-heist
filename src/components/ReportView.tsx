    ...
    <div className="min-h-screen bg-charcoal">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="space-y-8">
          <TargetProfile profile={report.targetProfile} />
          <HeistPlan steps={report.heistPlan} />
          <ThreatLevel threat={report.threatLevel} seriousMode={seriousMode} />
          <WhatAICantSteal
        ...
        <footer className="mt-12 pt-8 border-t border-fog text-center">
          <p className="text-muted text-sm font-mono">
